...
public class DatabaseLoader implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        ...
        Producto pro1 = new Producto("LAPTOP", 3600);
        Producto pro2 = new Producto("TABLET", 650);
        Producto pro3 = new Producto("MOUSE", 150);
        ...
        VentaLugar ven1 = new VentaLugar("CUSCO");
        VentaLugar ven2 = new VentaLugar("LORETO");
